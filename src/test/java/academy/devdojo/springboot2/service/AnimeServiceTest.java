...
class AnimeServiceTest {
	...
	@Test
	@DisplayName("listAll returns a page when successful")
	void listAll_ReturnsAPage_WhenSuccessful() {
		...
		Assertions.assertThat(animePage.toList().get(0).getName()).isEqualTo(expectedAnime.getName());
	}
	...
	void listAll_ReturnsListOfAnime_WhenSuccessful() {
		...
		Assertions.assertThat(animes.get(0)).isEqualTo(expectedAnime);		
	}
	...
	void findByIdOrThrowBadRequestException_ReturnsAnime_WhenSuccessful() {
		//Anime expectedAnime = AnimeCreator.createValidAnime();
		//Anime animeFound = animeService.findByIdOrThrowBadRequestException(1);
	...
	@Test
	@DisplayName("findByName returs a list of Anime when Successful")
	void findByName_ReturnAListOfAnime_WhenSuccessful() {
		String expectedName = AnimeCreator.createValidAnime().getName();
		List<Anime> animes = animeService.findByName("something");
